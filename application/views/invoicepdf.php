...
<div class="invoice-box">
    <table cellpadding="0" cellspacing="0">
        <tr class="item info">
            ...
            <td class="title">
            <img src="<?php echo base_url(); ?>assets/images/final/logo.png" style="width: 500px;; max-width:250px;">
                            </td>
            <td>
            <strong>Invoice #:</strong> <?php echo $invoice[0]->invoiceID; ?><br>
                                <strong>Jatuh Tempo:</strong> <?php echo $invoice[0]->duedate; ?><br>
	...
	<tr class="item">
        ...
        <tr class="item">
            ...
            <td><strong><?php echo settings()[0]->currency . " " . number_format($subTotal, 0); ?></strong></td>
        </tr>
        <tr class="item">
            <td><strong>Discount</strong></td>
            <td><strong><?php echo settings()[0]->currency . " " . number_format($discountTotal, 0); ?></strong></td>
        </tr>
        <tr class="item">
            <td><strong>Vat (<?php echo settings()[0]->vat;?>%)</strong></td>
            <td><strong><?php echo settings()[0]->currency . " " . number_format($vatTotal, 0); ?></strong></td>
        </tr>
        <tr class="item">
            <td><strong>Total</strong></td>
            <td><strong><?php echo settings()[0]->currency . " " . number_format($netTotal, 0); ?></strong></td>
        </tr>
    </table>
</div>