        ...
        <div class="x_content">
            <?php foreach ($settings as $set) : ?>
                <form id="settings" class="form-horizontal form-label-left" role="form" enctype="multipart/form-data" method="post" action="<?php echo base_url(); ?>settings/insert" accept-charset="utf-8">
                    ...
                    <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Slogan </span></label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control col-md-7 col-xs-12" id="name" name="slogan" type="text" placeholder="Enter Slogan Here" value="<?php echo $set->slogan; ?>" >
                        </div>
                    </div>
                    ...
                    <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">City *</span></label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control col-md-7 col-xs-12" name="city" type="text" placeholder="Enter City" value="<?php echo $set->city; ?>" >
                        </div>
                    </div>

                    <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Country *</span></label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control col-md-7 col-xs-12" name="country" type="text" placeholder="Enter Country" value="<?php echo $set->country; ?>" >
                        </div>
                    </div>

                    <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Zip Code *</span></label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control col-md-7 col-xs-12" name="zip" type="text" placeholder="Enter Zip Code" value="<?php echo $set->zip; ?>" >
                        </div>
                    </div>
