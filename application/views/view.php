        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <div class="col-md-9 col-sm-9 col-xs-12">.
                    ...
                    <div class="x_panel">
                        <div class="x_title">
                            <h2><i class="material-icons">perm_identity</i> INFORMASI </h2>
                            <div class="clearfix"></div>
                        </div>
                        <div class="x_content ">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="left col-xs-7">
                                            ...
                                            <ul class="list-unstyled">
                                                <li><i class="fa fa-building fa-fw"></i> Alamat: <?php echo $staff->area;?> </li>
                    ...
                    <div class="x_panel">
                        <div class="x_title">
                            <h2><i class="material-icons">show_chart</i> Laporan</h2>
                            <div class="clearfix"></div>
                        </div>
                        <div class="x_content ">
                            <form class="form-horizontal form-label-left" role="form" enctype="multipart/form-data" method="post" action="<?php echo base_url(); ?>user/reports" accept-charset="utf-8">
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Pilih Tahun</label>
