...
<div class="col-md-11 col-sm-11 col-xs-11 rightSideWrapper">
    <div class="x_panel">
        <div class="x_title">
            <h2><i class="fa fa-bar-chart fa-fw"></i> Pemasukan & Pengeluaran </h2>
        ...
        <div class="x_content">
            <div class="row tile_count">
                <div class="col-md-5 col-md-offset-1">
                    <h3 class="title text-center">Total User di Area</h3>
                    <canvas id="areaChart" width="400" height="200"></canvas>
                </div>
                <div class="col-md-5">
                    <h3 class="title text-center">Total User Di bawah Staff</h3>
            ...
            <div class="row tile_count">
                <div class="animated flipInY col-md-4 col-sm-4 col-xs-4 tile_stats_count">
                    ...
                    <div class="count green"><?php
                        ...
                        $sum = $this->db->get();
                        $sum = $sum->result()[0];
                        echo number_format($sum->amount, 0);
                        ?></div>
                </div>
                <div class="animated flipInY col-md-4 col-sm-4 col-xs-4 tile_stats_count">
