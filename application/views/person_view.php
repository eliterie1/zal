...
<body>
    <div class="container">
        <h1 style="font-size:20pt">Data Pelanggan Studi Photo Lembah Coding</h1>
        <br />
...
function edit_person(id)
{
    ...
    $.ajax({
        ...
        success: function(data)
        {
            ...
            $('[name="wa"]').val(data.wa);
            $('[name="no_foto"]').val(data.no_foto);
            $('[name="ukuran_foto"]').val(data.ukuran_foto);
            ...
            <div class="modal-body form">
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3">no foto</label>
                            <div class="col-md-9">
                                <input name="no_foto" placeholder="no_foto" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3">ukuran foto</label>
                            <div class="col-md-9">
                                <input name="ukuran_foto" placeholder="ukuran foto" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <textarea name="catatan" placeholder="Catatan" class="form-control"></textarea>
                                <span class="help-block"></span>
                            </div>
                        </div>
                    </div>
